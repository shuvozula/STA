...
def main():
    ...
    #filelocation = "../../A-Star equipped/" #
    #filelocation = "C:\\Documents and Settings\\Shuvo Saha\\Desktop\\ROBOTICS\\STAFiles\\Concurrent Task Allocation for ASyMTRe-D\\code\\IDA-star equipped\\src\\"
    #filelocation = "C:\\Documents and Settings\\Shuvo Saha\\Desktop\\ROBOTICS\\STAFiles\\Concurrent Task Allocation for ASyMTRe-D\\code\\IDA-star equipped\\src\\"
    filelocation = ""#"C:\\Documents and Settings\\ssaha\\Desktop\\My Research\\A-Star equipped\\"
    f = open(filelocation + "input.txt", "r")
    fcontent = f.read()
    screenDump = True

    r = createTaskScheduleASTAR(fcontent, screenDump)
    xtime = r.run()
    #print xtime
